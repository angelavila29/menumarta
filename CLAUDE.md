...
- Supabase (Postgres + Auth magic link) como base de datos y login.
  Esquema en `supabase/schema.sql`, `supabase/schema_menu.sql`, `supabase/schema_onboarding.sql`, `supabase/schema_social.sql` y `supabase/schema_pantry.sql` (idempotentes, se pegan en el SQL Editor).
